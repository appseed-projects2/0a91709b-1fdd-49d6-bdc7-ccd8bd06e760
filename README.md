...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-08-20 20:32`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/0a91709b-1fdd-49d6-bdc7-ccd8bd06e760.git
$ cd 0a91709b-1fdd-49d6-bdc7-ccd8bd06e760
```
